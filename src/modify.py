...
#						print "rr: "+sql+"\n"
				...
				if area=='連江縣' or area=='金門縣' or int(term)>=98:
					term = '%d'%((int(term)-66)/4)
				#elif area=='新竹市' or area=='嘉義市':
				#	term = 8
				else:
				...
				#print area
				#if  area.decode('utf-8') == '屏東縣'  or  area.decode('utf-8') == '宜蘭縣'  or area.decode('utf-8') == '南投縣'  or area.decode('utf-8') == '桃園縣‘ or  :
				#	'臺中縣'
				#	'臺北縣'
				#	'臺南縣'
				#	'花蓮縣'
